...
export const Deposit = ()=>{
  ...
  function valueChanged() {
    // console.log(document.getElementById("withdrawAmount").value, typeof document.getElementById("withdrawAmount").value)
  ...
  function changeBalance() {
    ...
    try {
      ...
      alert("The deposited amount is Not A Number.")
    }
  }
      ...
      body={
        ...
        (<div>
          ...
          <div className="input-group mb-3" >
            ...
            <input id="depositSubmit" disabled={!activate} type="submit" value="Deposit" className="form-control" onClick={changeBalance}></input>
          </div>
        </div>): (
              <div style={{height:'120px'}}>
                ...
                <button   type="submit" className="btn btn-dark successButton" onClick={clearForm}>Make another deposit</button>
              </div>
