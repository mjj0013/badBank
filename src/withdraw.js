      ...
      body={show ? (  
        <div>
            ...
            <div className="input-group mb-3" >
              ...
              <input id="withdrawSubmit" disabled={!activate} type="submit" value="Withdraw" className="form-control" onClick={changeBalance}></input>
            </div>
          </div>): (
              <div style={{height:'120px'}}>
                ...
                <button  type="submit" className="btn btn-dark successButton" onClick={clearForm}>Make another withdraw</button>
              </div>
